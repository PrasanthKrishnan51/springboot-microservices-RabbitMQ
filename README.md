...
│       ├── event/{OrderCreatedEvent, InventoryResponseEvent}.java
│       ├── repository/OrderRepository.java
│       └── service/{OrderService, InventoryResponseConsumer}.java
├── inventory-service/
│   ├── Dockerfile
│   ├── pom.xml
...
│       ├── dto/{OrderCreatedEvent, InventoryResponseEvent}.java
│       ├── entity/Inventory.java
│       ├── repository/InventoryRepository.java
│       └── service/{InventoryService, InventoryController}.java
